...
PROMPT_VARIANTS = {
    'original': "Respond in the following format: <think> ... </think> <answer> ... </answer>",
    'no_thinking': "Provide your answer directly in the following format: <answer> ... </answer>",
    'strict': """You must respond in exactly this format: <think> ... </think> <answer> ... </answer>
The <think> section should contain your step-by-step reasoning.
The <answer> section should contain ONLY the final answer, with no extra text.
Do not include any text outside these tags.""",
    'simple': "Think step-by-step, then provide your final answer in this format: <think> ... </think> <answer> ... </answer>",
    'free': "Solve the problem. You may use <think> and <answer> tags to structure your response if helpful.",
}

# 預設使用原始版本
system_prompt = PROMPT_VARIANTS['original']

def set_prompt_variant(variant: str):
    """切換 prompt 變體"""
